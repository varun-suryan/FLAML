...
# python test/vw/run_autovw.py   final_ns10  5k_1_5 -m  ChaCha Random  -log  -rerun -d oml_1206_10
# python test/vw/run_autovw.py   final_ns10  5k_1_5 -m  ChaCha Random  -log  -d oml_5648_10 -show_plot
#python test/vw/run_autovw.py   final_ns10  5k_1_5 -m  ChaCha Random  -log   -d oml_5648_10 -rerun 
# python test/vw/run_autovw.py   final_ns10  5k_1_5 -m  Random  -log   -d oml_344_10 -rerun 

###EXP running
# python test/vw/run_autovw.py   final  10k_1_5  -log   -m Exhaustive  -rerun  -seed 0 1 2 3 4
# python test/vw/run_autovw.py   final  10k_1_5  -log   -m Vanilla -rerun  -seed 0 1 2 3 4
# python test/vw/run_autovw.py   final  10k_1_5  -log   -m Random -rerun  -seed 0 1 2 3 4
# python test/vw/run_autovw.py   final  10k_1_5  -log   -m ChaCha -rerun  -seed 0 1 2 3 4
# python test/vw/run_autovw.py   final  10k_1_5  -log   -m ChaCha_pause_old -rerun  -seed 0 1 2 3 4

# python test/vw/run_autovw.py   final  100k_1_5  -log   -m Exhaustive  -rerun  -seed 0 1 2 3 4
# python test/vw/run_autovw.py   final  100k_1_5  -log   -m Vanilla -rerun  -seed 0 1 2 3 4
# python test/vw/run_autovw.py   final  100k_1_5  -log   -m Random -rerun  -seed 0 1 2 3 4
# python test/vw/run_autovw.py   final  100k_1_5  -log   -m ChaCha -rerun  -seed 0 1 2 3 4
# python test/vw/run_autovw.py   final  100k_1_5  -log   -m ChaCha_pause_old -rerun  -seed 0 1 2 3 4

# python test/vw/run_autovw.py   final  100k_1_5  -log   -m ChaCha_pause_old  Random Exhaustive Vanilla -p  -seed 0 1 2 3 4

# python test/vw/run_autovw.py   final  10k_1_5  -log   -m ChaCha ChaCha_pause_old  Random  -p  -seed 0 1
# python test/vw/run_autovw.py   final  10k_1_5  -log   -m ChaCha ChaCha_pause_old  Random  -p  -seed 0 1

##Test

# python test/vw/run_autovw.py   all_oml_regression  10k_1_5  -log   -m ChaCha ChaCha_pause_old Exhaustive Random -rerun  -seed 0 -d oml_344_10

# python test/vw/run_autovw.py   final  10k_1_5  -log   -m ChaCha_pause_old  ChaCha Exhaustive Random Vanilla -rerun  -seed 0 1 2 3 4
## get the full list of regression tasks
# python test/vw/run_datasets.py

#Test 
# python test/vw/run_autovw.py   all_oml_regression  50k_1_5  -log   -m Exhaustive Vanilla -rerun  -seed 0 -d oml_42822_10
# python test/vw/run_autovw.py   all_oml_regression  50k_1_5  -log   -m Exhaustive Vanilla -rerun  -seed 0 -d oml_42225_10
# python test/vw/run_autovw.py   all_oml_regression  50k_1_5  -log   -m Exhaustive Vanilla -rerun  -seed 0 -d oml_42688_10

## RUN
# python test/vw/run_autovw.py   all_oml_regression  50k_1_5  -log   -m ChaCha_pause_old  ChaCha Exhaustive Random Vanilla -rerun  -seed 0 1 2 3 4 -d oml_42225_10
# python test/vw/run_autovw.py   all_oml_regression  50k_1_5  -log   -m ChaCha_pause_old  ChaCha Exhaustive Random Vanilla -rerun  -seed 0 -d oml_42821_10
# python test/vw/run_autovw.py   all_oml_regression  50k_1_5  -log   -m ChaCha_pause_old  ChaCha Exhaustive Random Vanilla -rerun  -seed 0 -d oml_42183_10

#rm ./test/vw/vw_benchmark/data/openml_vwdatasets/ds_1575_10_0.vw
###non-stationary 42183

# python test/vw/run_autovw.py   final  10k_1_5  -log   -m ChaCha_pause_old  ChaCha Exhaustive Random Vanilla -rerun  -seed 0 1 2 3 4
# python test/vw/run_autovw.py   final  50k_1_5  -log   -m ChaCha_pause_old  ChaCha Exhaustive Random Vanilla -rerun  -seed 0 1 2 3 4
# python test/vw/run_autovw.py   final  10k_1_5  -log   -m  ChaCha_aggressive  ChaCha_wo_champion -rerun  -oml_5648_10 -seed 0 1
